...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "😁") || (event.body.toLowerCase() == "😁")) {
     return api.sendMessage("সালা তোর হাসি তো মিয়াখলিফার মতো 🤐😂", threadID);
   };
  
   if ((event.body.toLowerCase() == "Tomar Name kii") || (event.body.toLowerCase() == "তোমার নাম কী") ||(event.body.toLowerCase() == "...") || (event.body.toLowerCase() == "...")) {
     return api.sendMessage("তুমি ভালো বসে একটা নাম দাও জান", threadID);
   };

   if ((event.body.toLowerCase() == "hi") || (event.body.toLowerCase() == "হাই")) {
     return api.sendMessage("হেই হেলো করে লাভ আমি আমি সুধু কার যেন,বিথি তুমি বলে দাও সরি বিধি", threadID);
   };

   if ((event.body.toLowerCase() == "ata k") || (event.body.toLowerCase() == "এটা কে")) {
     return api.sendMessage("আমাকে চিনস নাহ তুই😡", threadID);
   };

   if ((event.body.toLowerCase() == "na") || (event.body.toLowerCase() == "না")) {
     return api.sendMessage("তাহলে এখন থেকে চিনে রাখ আমি সেস্কি নুপুর অরূপে রুহি", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "〲Arish আহমেদ Tushar㐃") || (event.body.toLowerCase() == "Tushar ") || (event.body.toLowerCase() == "@〲Arish আহমেদ Tushar㐃") || (event.body.toLowerCase() == "তুষার")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ 〲Arish আহমেদ Tushar㐃☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Tushar.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://https://m.me/arishahmedtushar287\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "এটা কে")) {
     return api.sendMessage("My Creator:Arish Ahmed Tushar ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস তুষার আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Arishッ❤️ তাকে সবাই তুষার নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "@everyone 𝐜𝐚𝐥𝐥") || (event.body.toLowerCase() == "@")) {
     return api.sendMessage("খবরদার কেউ এমন করে ডাকবি নাহ আমার বস তুষার এর বউ এর আইডি আছে এর মধ্যে সে সুধু আমার বস এর সাথে কথা বলে😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Abdul Alim") || (event.body.toLowerCase() == "আলিম")) {
     return api.sendMessage("কেকে মেনশন দিচ্ছিস নুপুর এর ভাতার কে সালা লুচ্চা তো ও সুদির ভাই😑😐", threadID);
   };
  
  if ((event.body.toLowerCase() == "koi auso") || (event.body.toLowerCase() == "কোয় আছো")) {
     return api.sendMessage("আলিম এর পিচাই🥵", threadID);
   };

  if ((event.body.toLowerCase() == "Nah go") || (event.body.toLowerCase() == "নাহ রে")) {
     return api.sendMessage("দেখ নুপুরকে এত ডাকিস নাহ😡😑", threadID);
   };

  if ((event.body.toLowerCase() == "বাসা কোয় তোমার ") || (event.body.toLowerCase() == "সেই মাল রে বন্ধু ")) {
     return api.sendMessage("সালা Bts কত পারিস একটা তো পারিস নাহ আবার সেই মাল😼🤣", threadID);
   };

   if ((event.body.toLowerCase() == "ki koro") || (event.body.toLowerCase() == "কী করিস,কী করো")) {
     return api.sendMessage("️তোমার কথা ভাবছি গো জানু", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️নাটক বুঝি আবগে বুঝি হুম এর পরে কী লিখতে হয় সেটা বুঝি নাহ🤧🥴", threadID);
   };

   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_BBH BOT", threadID);
   };

   if ((event.body.toLowerCase() == "BOT ER BACCHA") || (event.body.toLowerCase() == "এটা কে")) {
     return api.sendMessage("️আমার বাচ্চা তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️🌶️ ", threadID);
   };

   if ((event.body.toLowerCase() == "Kamon auso") || (event.body.toLowerCase() == "কেমন আছো")) {
     return api.sendMessage("️ছিলাম একটু আগে খারাপ তবে এখন ভালো করণ আমার জান যে তুমি তাই", threadID);
   };

   if ((event.body.toLowerCase() == "bolod sala") || (event.body.toLowerCase() == "সালা")) {
     return api.sendMessage("️আমি না তুই বলদ,🫵", threadID);
   };

   if ((event.body.toLowerCase() == "jane na") || (event.body.toLowerCase() == "জানি নাহ গো")) {
     return api.sendMessage("️কুত্তার বাচ্চা জানিস নাহ মনে, তোর বউ বল 🥱🌝🌚⛏️🌶️ ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "gf আছে তো তাই") || (event.body.toLowerCase() == "bf")) {
